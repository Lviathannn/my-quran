...
export default function SekeletonAyat({}: Props) {
    return (
        <div className=" arab flex w-full flex-col gap-10 rounded-lg bg-white py-12 px-10 dark:bg-slate-600">
            <div className="flex items-center justify-between gap-5">
                <p className=" flex h-5 w-5 items-center justify-center rounded-full bg-emerald-50 p-4 font-medium text-emerald-600 dark:bg-emerald-400"></p>
