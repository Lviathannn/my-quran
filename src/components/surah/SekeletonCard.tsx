...
export default function SekeletonCard({}: Props) {
   return (
      <div className="flex animate-pulse flex-col gap-5 rounded-xl bg-white px-5 py-5">
         <div className="flex justify-between">
            <div className=" flex h-5 w-5 items-center justify-center rounded-full bg-emerald-50 p-4 font-medium text-emerald-600"></div>
